        ...
        <?php foreach ($materi as $profil) : ?>
            <div class="card">
                <div class="card-header">
                    ...
                    <td><a href="<?php echo base_url() . 'user/download_sma/' . $profil['filename'] ?>" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-download-alt">Download Full</a></td>
                </div>
            </div>
        <?php endforeach ?>
