            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            <a class="dropdown-item" href="<?= base_url('user/smp') ?>" style="color: black">Matematika</a>
                            <a class="dropdown-item" href="<?= base_url('user/smp_1') ?>" style="color: black">Bahasa indonesia</a>
                            <a class="dropdown-item" href="<?= base_url('user/smp_2') ?>" style="color: black">IPA</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#login" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
